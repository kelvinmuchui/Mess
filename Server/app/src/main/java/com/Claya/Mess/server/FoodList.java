...
import com.Claya.Mess.server.Model.Food;
import com.Claya.Mess.server.ViewHolder.FoodViewHolder;
...
public class FoodList extends AppCompatActivity {
    ...
    private void showAddFoodDialog() {
        ...
        alertDialog.setTitle("Enter new Food");
        ...
        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int i) {
                ...
                if (newFood != null){
                    ...
                    Snackbar.make(food_list_layout, "new food "+ newFood.getName()+"Has been added", Snackbar.LENGTH_SHORT)
                            .show();
                }
            }
        });
    ...
    private void chooseImage() {
        ...
        startActivityForResult(Intent.createChooser(intent,"Claya"), Common.PICK_IMAGE_REQUEST);
    }
    ...
    private void showUpdateFoodDialog(final String key, final Food item) {
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(FoodList.this);
        alertDialog.setTitle("EDIT the list of food");
        ...
        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int i) {
                ...
                Snackbar.make(food_list_layout, "food data "+ item.getName()+"have been add", Snackbar.LENGTH_SHORT)
                        .show();
                }
        });
        alertDialog.setNegativeButton("NO", new DialogInterface.OnClickListener() {
