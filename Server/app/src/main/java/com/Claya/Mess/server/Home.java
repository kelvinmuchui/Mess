...
import com.Claya.Mess.server.Model.Category;
import com.Claya.Mess.server.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
        ...
        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int i) {
                ...
                if (newCategory != null){
                    ...
                    Snackbar.make(drawer, "New menu "+ newCategory.getNama()+"Uploaded", Snackbar.LENGTH_SHORT)
                            .show();
                }
            }
        });
    ...
    private void showUpdateDialog(final String key, final Category item) {
        ...
        alertDialog.setMessage("Add all information!");
